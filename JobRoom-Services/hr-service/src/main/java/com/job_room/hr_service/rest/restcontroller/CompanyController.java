package com.job_room.hr_service.rest.restcontroller;

import com.job_room.hr_service.configuration.BaseAPI;
import com.job_room.hr_service.model.company.CompanyDto;
import com.job_room.hr_service.model.company.CompanyRequest;
import com.job_room.hr_service.model.company.CompanyResponse;
import com.job_room.hr_service.rest.message.*;
...
@RestController
@RequestMapping(BaseAPI.BASE_API_URL)
public class CompanyController {
    ...
    public ResponseEntity<ErrorResponse> handleValidationExceptions(MethodArgumentNotValidException ex){
        ...
        response.setMessage(messageProperties.insertError("Company"));
    ...
    public ResponseEntity<BaseApiResponse<CompanyResponse>> selectCompanyByIdNotBanned(@PathVariable int id) {
...
//    }
    ...
    //TODO: Select company by id =========================================================
    @GetMapping("/companies/admin/{id}")
    public ResponseEntity<BaseApiResponse<CompanyResponse>> selectCompanyById(@PathVariable int id) {

        BaseApiResponse<CompanyResponse> baseApiResponse = new BaseApiResponse<>();
        CompanyDto companyDto = companyService.findByIdAndStatusIsTrueForAdmin(id);
    ...
    //TODO: Select company by UUID =========================================================
    @GetMapping("/companies/by-uuid/{uuid}")
    public ResponseEntity<BaseApiResponse<CompanyResponse>> selectCompanyById(@PathVariable String uuid) {

        BaseApiResponse<CompanyResponse> baseApiResponse = new BaseApiResponse<>();
        CompanyDto companyDto = companyService.findByUUID(uuid);
