package com.job_room.hr_service.rest.message;
...
public class MessageProperties {
    ...
    public String banned(String resourceName){
        return accessor.getMessage("message.banned", new Object[] {resourceName});
    }

    public String unbanned(String resourceName){
        return accessor.getMessage("message.unbanned", new Object[] {resourceName});
    }
