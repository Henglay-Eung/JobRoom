...
public class CvDto {
    ...
    public CvDto(int id, String name, Employee employee, PersonalData personalData, Information information, List<Education> educations, List<Experience> experiences, List<Certification> certifications, List<Skill> skills, List<Language> languages, List<ReferenceCv> referenceCvs, boolean isPublic, boolean status) {
        this.id = id;
        this.name = name;
