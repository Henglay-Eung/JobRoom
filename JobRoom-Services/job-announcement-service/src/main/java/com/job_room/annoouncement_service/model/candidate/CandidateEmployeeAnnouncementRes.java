...
public class CandidateEmployeeAnnouncementRes {
    ...
    public CandidateEmployeeAnnouncementRes(int id, int announcementId,String name, AnnouncementResponse announcement, int employeeId, CandidateEmployee employee, String appliesDate, String cvLink, boolean status) {
        this.id = id;
