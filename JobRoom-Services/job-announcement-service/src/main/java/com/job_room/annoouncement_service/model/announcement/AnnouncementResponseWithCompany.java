...
public class AnnouncementResponseWithCompany {
    ...
    public AnnouncementResponseWithCompany(int id, String uuid, String position, String caption, Map<String, Object> form, String createdDate, String publishedDate, String closedDate, String thumbnail, String image, String type, int numberOfHiring, String salaryRank, String location, int companyId, Company company, int candidateCount, boolean isShared, boolean isBanned, boolean isDraft, boolean status) {
        this.id = id;
        this.uuid = uuid;
