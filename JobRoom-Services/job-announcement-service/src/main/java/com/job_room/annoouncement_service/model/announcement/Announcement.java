...
public class Announcement {
    ...
    public Announcement(int id, String uuid, String position, String caption, Map<String, Object> form, Timestamp createdDate, Date publishedDate, Date closedDate, String thumbnail, String image, String type, String salaryRank, String location, int numberOfHiring, boolean isShared, boolean isBanned, boolean isDraft, int companyId, boolean status) {
        this.id = id;
        this.uuid = uuid;
